        ...
        <div class="container mx-auto mt-12">
                    ...
                    <div class="flex md:order-2">
                            ...
                            <a href="/users">
                                <div class="flex items-center pl-3">
                                    <svg xmlns="http://www.w3.org/2000/svg"
                                         class="h-6 w-6 fill-cyan-300 hover:fill-cyan-400 dela" viewBox="0 0 24 24"
                        ...
                        <div class="hidden relative mr-3 md:mr-0 md:block">
                            <a href="/users/create">
                                <div class="flex items-center pl-3">
                                    <svg xmlns="http://www.w3.org/2000/svg"
                                         class="h-6 w-6 transition fill-green-300 hover:fill-green-400 duration-300"
            ...
            <div class="flex flex-col items-center">
                <div class="grid grid-cols-5 gap-12">
                    ...
                    <div class="mt-12 col-span-4 max-w-sm bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700 p-4">
                        <div class="flex flex-col items-center pb-10 pt-6">
                            <img class="mb-3 w-24 h-24 rounded-full shadow-lg"
                                 src="https://source.unsplash.com/user/erondu" alt="Bonnie image"/>
                                    ...
                                    <?php if (isset($entity->id)): ?>
                                        <div class="hidden relative mr-3 md:mr-0 md:block">
                                            <a href="/users/<?= $entity->id ?>/edit">
                                                <div class="flex items-center pl-3">
                                                    <svg xmlns="http://www.w3.org/2000/svg"
                                                         class="h-6 w-6 fill-yellow-300 hover:-yellow-400"
                                                         viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                                        <path stroke-linecap="round" stroke-linejoin="round"

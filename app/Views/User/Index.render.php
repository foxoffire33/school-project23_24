                ...
                <div class="container flex flex-wrap justify-between items-center mx-auto">
                    <div class="flex md:order-2">
                        <div class="hidden relative mr-3 md:mr-0 md:block">
                            <div class="flex left-0 items-center pl-3">
                                <div class=" relative mr-3 md:mr-0 md:block">
                                    <a href="/users/create">
                                        <div class="flex items-center pl-3">
                                            <svg xmlns="http://www.w3.org/2000/svg"
                                                 class="h-6 w-6  fill-green-300 hover:fill-green-400"
                                        ...
                                        <td class="z-1 px-6 py-4 text-sm leading-5 text-gray-500 whitespace-no-wrap border-b border-gray-200 w-1/12">
                                            <div class="hidden relative mr-3 md:mr-0 md:block">
                                                <a href="/users/<?= $entity->id ?>">
                                                    <div class="flex items-center pl-3">
                                                        <svg xmlns="http://www.w3.org/2000/svg" class="z-40 h-6 w-6 fill-green-300 hover:full-geen-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">

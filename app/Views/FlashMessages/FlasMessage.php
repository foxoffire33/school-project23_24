<div class="py-8 px-6">
    <div class="p-6 bg-red-50 border-l-4 border-indigo-500 rounded-r-lg">
        <div class="flex">
            <div class="w-auto">
        <span class="w-auto inline-block mr-2">
          <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="w-full">
                ...
                <div class="pr-6">
                    <p class="text-sm text-red-700">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Reprehenderit vel expedita, aut similique voluptates modi dolorem maxime illum.</p>
                </div>
            </div>
        </div>
    </div>

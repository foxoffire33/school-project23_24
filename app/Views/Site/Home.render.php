        ...
        <div class="grid grid-cols-3 gap-4 mt-8">
            <div>
                <div class="p-6 max-w-sm bg-white rounded-lg border border-gray-200 shadow-md">
                    ...
                    <a href="#"
                       class="inline-flex items-center py-2 px-3 text-sm font-medium text-center text-white bg-gray-700 rounded-lg hover:bg-gray-600 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                        Read more

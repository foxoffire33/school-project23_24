<aside class="w-64" aria-label="Sidebar">
   <div class="overflow-y-auto rounded dark:bg-gray-800">
      <ul class="space-y-2">
<!--         <li>-->
...
<!--         </li>-->
         <li>
            <a href="/coins" class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
               <span class="flex-1 ml-3 whitespace-nowrap">Coins</span>
            </a>
         </li>
         <li>
         ...
         <li>
            <a href="/transactions" class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
               ...
               <span class="flex-1 ml-3 whitespace-nowrap">Trancactions</span>
            </a>
         </li>
      </ul>
   </div>

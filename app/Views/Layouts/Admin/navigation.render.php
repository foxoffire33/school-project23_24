    ...
    <div class="hidden lg:block">
        ...
        <ul>
            ...
            <li class="mb-2 bg-gray-800 rounded shadow">
                <a href="/users" class="inline-block w-full px-3 py-2 font-bold text-white">
            ...
            <li class="mb-2 rounded hover:shadow hover:bg-gray-800">
                <a href="/coins" class="inline-block w-full px-3 py-2 font-bold text-white">
                    <svg xmlns="http://www.w3.org/2000/svg" class="inline-block w-6 h-6 mr-2 -mt-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <li class="mb-2 rounded hover:shadow hover:bg-gray-800">
                <a href="/transactions" class="inline-block w-full  px-3 py-2 font-bold text-white">
                    <svg xmlns="http://www.w3.org/2000/svg" class="inline-block w-6 h-6 mr-2 -mt-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
